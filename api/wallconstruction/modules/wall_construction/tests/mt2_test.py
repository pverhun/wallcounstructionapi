from ..mt2 import WallConstructionMt2
import time
import unittest
...
class TestMt2(unittest.TestCase):
    ...
    LOG_FILE_DIRECTORY = 'wall_construction/tests/logs/mt2'

    def setUp(self) -> None:
        self.wall_construction = WallConstructionMt2(file_input=f'{self.INPUT_FILES_DIRECTORY}/input.txt',
